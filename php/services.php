...
<body>
    ...
    <div id="fil-ariane"> 
        <ul id="fil-ariane-historique">
            ...
            <li class="element-fil-ariane">Village fleuri</li>
        </ul>
    </div>
    ...
    <div class="div-principal">
        <h2 class="titre-div-principal h2-principaux">Présentation</h2>
        <p>Quelques informations par rapport à la ville (voir BDD)</p>
    </div>
    <hr />
    <div class="div-principal">
        <h2 class="titre-div-principal h2-principaux">Les différents services</h2>
        <p>CARTE</p>
    </div>
    <hr />
    <div class="div-principal">
        <h2 class="titre-div-principal">Associations</h2>
        <p>CARTE</p>
    </div>
    ...
    <footer>
        <a href="">Mentions légales et partenaires</a>
        <p> Mis à jour le : </p>
    </footer>
</body>
</html>
...
<img src="../images/banniere.jpg"/>
    ...
    <form action="php/searchleo.php">
      ...
      <div id="research"><INPUT type=submit value=Envoyer><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M236 176c0 15.46-12.54 28-28 28S180 191.5 180 176S192.5 148 208 148S236 160.5 236 176zM500.3 500.3c-15.62 15.62-40.95 15.62-56.57 0l-119.7-119.7c-40.41 27.22-90.9 40.65-144.7 33.46c-91.55-12.23-166-87.28-177.6-178.9c-17.24-136.2 97.29-250.7 233.4-233.4c91.64 11.6 166.7 86.07 178.9 177.6c7.19 53.8-6.236 104.3-33.46 144.7l119.7 119.7C515.9 459.3 515.9 484.7 500.3 500.3zM294.1 182.2C294.1 134.5 255.6 96 207.1 96C160.4 96 121.9 134.5 121.9 182.2c0 38.35 56.29 108.5 77.87 134C201.8 318.5 204.7 320 207.1 320c3.207 0 6.26-1.459 8.303-3.791C237.8 290.7 294.1 220.5 294.1 182.2z"/></svg></div>

      </form>
    <div id="searchBarre"><form><input type="text" id="name" name="name" required placeholder="Rechercher..."><a href="php/departement.php"><div id="research"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M236 176c0 15.46-12.54 28-28 28S180 191.5 180 176S192.5 148 208 148S236 160.5 236 176zM500.3 500.3c-15.62 15.62-40.95 15.62-56.57 0l-119.7-119.7c-40.41 27.22-90.9 40.65-144.7 33.46c-91.55-12.23-166-87.28-177.6-178.9c-17.24-136.2 97.29-250.7 233.4-233.4c91.64 11.6 166.7 86.07 178.9 177.6c7.19 53.8-6.236 104.3-33.46 144.7l119.7 119.7C515.9 459.3 515.9 484.7 500.3 500.3zM294.1 182.2C294.1 134.5 255.6 96 207.1 96C160.4 96 121.9 134.5 121.9 182.2c0 38.35 56.29 108.5 77.87 134C201.8 318.5 204.7 320 207.1 320c3.207 0 6.26-1.459 8.303-3.791C237.8 290.7 294.1 220.5 294.1 182.2z"/></svg></div></a></div>
  ...
  <script>
    ...
    function maFcontion() {
      ...
      if (count == 1) {
        ...
        imageslider.style.backgroundImage = "url('https://27.monvillagenormand.fr/images/300/327000359.webp')";
        imageslider1.style.backgroundImage = "url('https://27.monvillagenormand.fr/images/300/327000372.webp')";
        imageslider2.style.backgroundImage = "url('https://27.monvillagenormand.fr/images/300/327000362.webp')";
      }
      if (count == 2) {
        imageslider.style.backgroundImage = "url('https://27.monvillagenormand.fr/images/300/327000362.webp')";
        imageslider1.style.backgroundImage = "url('https://27.monvillagenormand.fr/images/300/327000371.webp')";
        imageslider2.style.backgroundImage = "url('https://27.monvillagenormand.fr/images/300/327000370.webp')";
      }
      if (count == 3) {
        count = 0;
        imageslider.style.backgroundImage = "url('https://27.monvillagenormand.fr/images/300/327000356.webp')";

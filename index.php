...
<img src="images/banniere2.png"/>
    ...
    <!--<div id="menuProfil"><a href="php/admin.php">Mon compte</a><a href="php/deconexion_back.php">Déconnexion</a></div>-->
<?php
      if($_SESSION['verif'] == 1){
        ?>
          <div id="menuProfil"><a href="php/admin.php">Mon compte</a><a href="php/deconexion_back.php">Déconnexion</a></div>
...
<div id="affichage" class="non-active">Résultat de la recherche</div>

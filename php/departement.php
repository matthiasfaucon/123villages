...
<body>
  ...
  <section id="activites">
    ...
    <div class="carteInformations">
      ...
      <h1 class='titreInfo'>Église Saint-Jean</h1>
        <div class="positionnementInfos">
          
          <img class='imageInfo' src="https://76.monvillagenormand.fr/images/800/476002725.webp">
          <div id="infoCarte">
          <p class='adresseInfo'><span>Adresse:</span> place Jules Ferry, 76500 Elbeuf-sur-Seine</p>
          <p class='type'><span>Type:</span> Eglise</p>
          <p class='coordonneesGeo'><span>Coordonnées:</span> 49.2914962769, 1.0035370588</p>
          <p class='telephoneInfo'><span>Téléphone:</span> 0232131050</p>
      </div>
        </div>
      </div>
    </div>

...
while ($donnees=$reponse->fetch())
{
    ...
    echo '<a href="departement.php?departement='.$donnees['departement_ville'].'&descritpion='.$donnees['description_depart'].'&num='.$donnees['num_depart'].'">/'.$donnees['departement_ville'].'</a>';
    echo '<a href="ville.php?departement='.$donnees['departement_ville'].'&code_postal='.$donnees['code_postal'].'&num='.$donnees['num_depart'].'&ville='.$donnees['nom_ville'].'&presentation='.$donnees['presentation_ville'].'&histoire='.$donnees['histoire_ville'].'">/'.$donnees['code_postal'].'/'.$donnees['nom_ville'].'</a>';
